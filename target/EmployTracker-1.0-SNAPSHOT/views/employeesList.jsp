            ...
            <div class="center-container">
                <div class="card">
                        <div class="input-wrapper">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                            ...
                            <c:forEach var="employee" items="${employees}">
                                <tr>
                                    ...
                                    <td style="display: flex; gap: 8px">
                                        <a href="/EmployTracker_war_exploded/employee?action=updateForm&id=${employee.id}">
                                            <button class="editBtn">
                                                <svg class="editSvg" viewBox="0 0 512 512">
                                        ...
                                        <form action="employee?action=delete" method="post">
                                            ...
                                            <button class="deletBtn">
                                                <svg class="deleteSvg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
